...
class AnalysisTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.media_preview.setStyleSheet("background-color: #222; color: white;")
        main_layout.addWidget(self.media_preview)
        ...
        controls_layout.addWidget(QLabel("Highlight Radius:"))
